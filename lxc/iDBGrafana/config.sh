...
Commands="pct exec $ctID -- bash -ci \"wget -qO - https://repos.influxdata.com/influxdb.key | apt-key add - > /dev/null 2>&1\"
          ...
          pct push $ctIP \"$script_path/lxc/iDBGrafana/proxmox.json\" \"/var/lib/grafana/dashboards/proxmox.json\"
