...
pct exec $ctID -- bash -ci "wget -q https://github.com/Radarr/Radarr/releases/download/${ghTag}/Radarr.master.${ghTag}.linux.tar.gz"
pct exec $ctID -- bash -ci "tar -xvzf Radarr.${ghTag}.linux.tar.gz > /dev/null 2>&1"
